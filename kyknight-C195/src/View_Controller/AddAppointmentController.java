...
public class AddAppointmentController implements Initializable {
    ...
    //Labels
    @FXML private Label addAppScreenLabel, addAppTitleLabel, addAppDescriptionLabel, addAppLocationLabel,
    ...
    //TextFields
    @FXML private TextField addAppTitleTextField, addAppLocationTextField, addAppContactTextField,
            addAppUrlTextField, addAppStartHourTextField, addAppStartMinuteTextField, addAppEndHourTextField, addAppEndMinuteTextField;
    //TextArea
    @FXML private TextArea addAppDescriptionTextField;
    //Buttons
    @FXML private Button addAppAddButton, addAppSaveButton, addAppCancelButton, addAppDeleteButton;
    
    //DatePicker
    @FXML private DatePicker addAppDatePicker;
    
    //ChoiceBox
    @FXML private ChoiceBox<String> addAppTypeChoiceBox, addAppStartAMPMChoiceBox, addAppEndAMPMChoiceBox;
    
    //TableViews
    @FXML private TableView<Customer> addModAppAddTableView;
    @FXML private TableColumn<Customer, String> addAppAddNameTableCol;
    @FXML private TableColumn<Customer, String> addAppAddCityTableCol;
    @FXML private TableColumn<Customer, String> addAppAddCountryTableCol;
    @FXML private TableColumn<Customer, String> addAppAddPhoneTableCol;
    
    @FXML private TableView<Customer> addModAppDeleteTableView;
    @FXML private TableColumn<Customer, String> addAppDeleteNameTableCol;
    @FXML private TableColumn<Customer, String> addAppDeleteCityTableCol;
    @FXML private TableColumn<Customer, String> addAppDeleteCountryTableCol;
    @FXML private TableColumn<Customer, String> addAppDeletePhoneTableCol;
    ...
    /**
     * This method, on the save button being selected, the app info is submitted to be added to the DB
     * @param event 
     */
    private void AddAppSaveButtonPushed(ActionEvent event){
        ...
        if (contact.length() == 0 && customer != null){
            ...
            String type = addAppTypeChoiceBox.getValue();
        ...
        String errorMessage = Appointment.isAppValid(customer, title, desc, location, appDate, startHr, startMin, startAmPm, endHr, endMin, endAmPm);
        ...
        if (addNewApp(customer, title, desc, location, contact, url, startUTC, endUTC)) {
            try {
